     ...
     //   JavascriptExecutor js = (JavascriptExecutor) driver;
      ...
      //  js.executeScript("arguments[0].scrollIntoView({block: 'center'});", radio);
       ...
       // js.executeScript("arguments[0].scrollIntoView({block: 'center'});", button);
        ...
        WebElement numberOfBoards = driver.findElement(By.xpath("//*[@id=\"t3-content\"]/div[3]/article/section/div[2]/div[3]/div[2]/div[1]/span"));
        Assert.assertEquals(numberOfBoards.getText(), "51");

        WebElement numberOfPackages = driver.findElement(By.xpath("//*[@id=\"t3-content\"]/div[3]/article/section/div[2]/div[3]/div[2]/div[2]/span"));
